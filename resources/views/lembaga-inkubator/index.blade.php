...
@section('content')
<div class="container li-shell"> {{-- JANGAN SAMPAI TERHAPUS: Ini pembungkus utamanya --}}
    
<div class="li-head text-center">
    <h1 class="li-title">Lembaga Inkubator</h1>
    
    @if(isset($namaProvinsi) && $namaProvinsi)
    ...
    <div class="li-table-wrap">
        <table class="table li-table mb-0">
            ...
            <tbody id="liTbody">
                {{-- Data dirender via lembaga-inkubator.js --}}
            </tbody>
        </table>
    </div>
...
</div> {{-- Penutup container li-shell --}}
@endsection
